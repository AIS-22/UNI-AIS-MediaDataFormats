...
For the purpose of comparison, an additional model was trained using images all available filesizes 5, 10, 17, 25, 32, 40, 50, 60, 75 and 100. This particular model utilized 9000 images during the training phase.
